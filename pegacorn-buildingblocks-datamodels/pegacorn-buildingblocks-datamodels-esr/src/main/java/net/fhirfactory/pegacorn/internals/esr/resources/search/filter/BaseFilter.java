package net.fhirfactory.pegacorn.internals.esr.resources.search.filter;
...
public abstract class BaseFilter {
    ...
    public abstract boolean doFilter(ExtremelySimplifiedResource searchResult);
    
    
    public BaseFilter(String param) throws ResourceInvalidSearchException {
		if (param.isEmpty()) {
