 ...
 * under the License.
 */
package net.fhirfactory.dricats.internals.events;
 ...
 */
public class EventExtensionSet {

    private static final Logger LOG = LoggerFactory.getLogger(EventExtensionSet.class);
    ...
    public EventExtensionSet(List<Extension> sourceExtensionEntityList) {
