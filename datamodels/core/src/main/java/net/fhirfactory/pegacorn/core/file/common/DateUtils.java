...
public class DateUtils {
    ...
    public static final String D_M_YYYY_H_MM_SS = "d/M/yyyy h:mm:ss";
    public static final String YYYY_MM_DD_T_HH_MM_SS_Z_INPUT = "yyyy-MM-dd'T'HH:mm:ssz";
    public static final String YYYY_MM_DD_T_HH_MM_SS_INPUT = "yyyy-MM-dd'T'HH:mm:ss";
    public static final String YYYY_MM_DD_T_HH_MM_SS_Z_OUTPUT = "yyyy-MM-dd'T'HH:mm:ssZ";
    public static final String YYYY_MM_DD_T_HH_MM_SS_ZOFFSET = "yyyy-MM-dd'T'HH:mm:ss[+-]hh:mm";    
