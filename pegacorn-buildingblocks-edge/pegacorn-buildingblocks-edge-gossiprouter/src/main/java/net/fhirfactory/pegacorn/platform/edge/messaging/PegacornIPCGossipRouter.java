...
public class PegacornIPCGossipRouter implements Runnable{
    private static final Logger LOG = LoggerFactory.getLogger(PegacornIPCGossipRouter.class);
    ...
    public static void main(String[] args) {
        CommandLine.run(new PegacornIPCGossipRouter(), args);
    }
