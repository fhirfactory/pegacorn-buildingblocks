package net.fhirfactory.pegacorn.platform.edge.answer.facades.resourcespecific;

import ca.uhn.fhir.rest.param.DateRangeParam;
import ca.uhn.fhir.rest.param.TokenParam;
import ca.uhn.fhir.util.DateUtils;
import net.fhirfactory.pegacorn.platform.edge.ask.http.InternalFHIRClientServices;
...
public class ProcedureSearches {
    ...
    public Bundle getProceduresWithSubjectAndDate(InternalFHIRClientServices accessor, Map<Property, Serializable> parameterSet) {
    ...
    public Bundle getProceduresWithSubjectAndDate(InternalFHIRClientServices accessor, String subjectIdentifierSystem, String subjectIdentifierTypeCode, String subjectIdentifierValue, Date startDate, Date endDate){
    ...
    public Bundle getProceduresWithSubjectAndDate(InternalFHIRClientServices accessor, Identifier identifier, DateRangeParam dateRangeParam){
        String identifierTypeCode = null;
