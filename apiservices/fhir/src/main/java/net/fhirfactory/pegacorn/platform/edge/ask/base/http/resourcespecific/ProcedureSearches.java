package net.fhirfactory.pegacorn.platform.edge.ask.base.http.resourcespecific;
...
public class ProcedureSearches {
    ...
    public Bundle getProceduresWithSubjectAndDate(InternalFHIRClientServicesBase accessor, Map<Property, Serializable> parameterSet) {
    ...
    public Bundle getProceduresWithSubjectAndDate(InternalFHIRClientServicesBase accessor, String subjectIdentifierSystem, String subjectIdentifierTypeCode, String subjectIdentifierValue, Date startDate, Date endDate){
    ...
    public Bundle getProceduresWithSubjectAndDate(InternalFHIRClientServicesBase accessor, Identifier identifier, DateRangeParam dateRangeParam){
        String identifierTypeCode = null;
